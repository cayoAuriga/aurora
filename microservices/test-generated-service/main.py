...
config = get_config("test-generated-service")
logger = get_logger("test-generated-service")

# Create service instance
service = create_service(
    service_name="test-generated-service",
    config=config,
    title="Generated Test Service",
    description="Aurora Generated Test Service microservice"
)

# Database dependency
get_db = get_db_dependency("test-generated-service")
...
async def root():
    """Root endpoint"""
    return {"message": "Generated Test Service is running"}
...
service.add_router(router, prefix="/api/v1", tags=["test-generated-service"])
