...
config = get_config("sample-api")
logger = get_logger("sample-api")
...
service = create_service(
    ...
    description="A sample API service generated for demonstration"
)

# Database dependency
get_db = get_db_dependency("sample-api")
...
async def root():
    """Root endpoint"""
    return {"message": "Sample API Service is running"}
...
service.add_router(router, prefix="/api/v1", tags=["sample-api"])
